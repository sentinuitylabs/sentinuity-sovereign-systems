...
HELP: dict[str, tuple[str, str]] = {
 ...
 "hunting_grounds": ("Smart Money Observatory — Wallet Intelligence Substrate",
  "Apex wallet register, Telegram signal array and enrichment health. Shows whether the wallet-intelligence layer is actually fed or honestly empty. (Key retains legacy id for wiring.)"),
