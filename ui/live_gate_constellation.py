...
def render_live_gate_constellation(st, db_path: str | Path, intel_db_path: str | Path | None = None) -> None:
    ...
    st.markdown(f'''
<style>
/* SIGNOFF_CONSTELLATION_V3_20260720 — colour doctrine: green=pass/go, violet=intelligence,
...
.lg-stage.block{{border-color:rgba(255,7,58,.72);background:radial-gradient(circle,rgba(255,7,58,.20),rgba(18,4,10,.82) 62%);box-shadow:0 0 22px rgba(255,7,58,.23),0 0 0 7px rgba(255,7,58,.025)}}.lg-stage.block .lg-orbit{{border-color:rgba(255,7,58,.38)}}.lg-stage.block .lg-core{{color:#FF073A;text-shadow:0 0 12px rgba(255,7,58,.8)}}
...
.lg-stage.final-block{{border-color:rgba(255,7,58,.72)}}.lg-stage.final-block .lg-core{{color:#FF073A;text-shadow:0 0 12px rgba(255,7,58,.8)}}
...
.lg-ribbon{{display:flex;gap:5px;overflow:auto;padding-bottom:3px}}.lg-ribbon span{{white-space:nowrap;border-radius:999px;padding:5px 8px;font:600 0.62rem/1 'Share Tech Mono',monospace}}.rh-gold{{color:#FFD700;border:1px solid rgba(255,215,0,.25);background:rgba(255,215,0,.035)}}.rh-be{{color:#8EF9FF;border:1px solid rgba(142,249,255,.18);background:rgba(142,249,255,.025)}}.rh-loss{{color:#FF073A;border:1px solid rgba(255,7,58,.20);background:rgba(255,7,58,.028)}}.rh-empty{{color:#536963!important}}
